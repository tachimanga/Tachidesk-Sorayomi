...
class AccountRegisterScreen extends HookConsumerWidget {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextField(
              decoration:
                  InputDecoration(labelText: context.l10n!.password_again),
              onChanged: (value) => passwordAgain.value = value,
              obscureText: true,
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  log('Register Email: ${email.value}, Password: ${password.value}, Password: ${passwordAgain.value}');
                  ...
                  if (password.value != passwordAgain.value) {
                    errorMsg.value = context.l10n!.password_not_match;
                    return;
                  }
                  logEvent3("USER:TAP:REGISTER");
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: context.l10n!.already_have_account),
                  const TextSpan(text: " "),
                  TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        context.replace(Routes.userLogin);
                      },
                  ),
                ],
              ),
